...
export const FEATURE_COMPARISON = [
  ...
  { feature: "保険会社ポータル", free: "〇", starter: "〇", standard: "〇", pro: "〇" },
  { feature: "CSV/PDFエクスポート", free: "—", starter: "単体のみ", standard: "〇", pro: "〇" },
  { feature: "レポート", free: "—", starter: "—", standard: "基本", pro: "詳細" },
  { feature: "API連携", free: "—", starter: "—", standard: "—", pro: "〇" },
  { feature: "監査ログ", free: "—", starter: "—", standard: "—", pro: "〇" },
