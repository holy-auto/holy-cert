...
const PhotoUploadSection = forwardRef<PhotoUploadHandle, Props>(function PhotoUploadSection(
  { maxPhotos, planLabel, onCountChange },
  ref,
) {
    ...
    <div className="border-t border-border-subtle pt-6 space-y-4">
      ...
      {!full && (
        ...
        >
          ...
          <div className="mt-2 text-sm font-medium text-secondary">写真を追加</div>
          ...
          <div className="mt-2 text-xs text-muted">ドラッグ&ドロップにも対応しています</div>
        </div>
      )}
