        ...
        <>
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="glass-card p-5">
                ...
                <div className="mt-2 text-3xl font-bold text-[#30d158]">{stats.activeCerts}</div>
              ...
              <div className="glass-card p-5">
                ...
                <div className="mt-2 text-3xl font-bold text-[#ff453a]">{stats.voidCerts}</div>
              ...
              <div className="glass-card p-5">
                ...
                <div className="mt-2 text-3xl font-bold text-[#0a84ff]">{stats.memberCount}</div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="glass-card p-5">
              ...
              <div className="mt-2 text-2xl font-bold text-[#ff9f0a]">¥{stats.unpaidAmount.toLocaleString()}</div>
            ...
            {stats.platformCertStats && (
              <>
                ...
                <div className="glass-card p-5">
                  ...
                  <div className="mt-2 text-3xl font-bold text-[#30d158]">{stats.platformCertStats.active}</div>
                  <div className="mt-1 text-xs text-muted">有効な施工証明書</div>
                </div>
              </>
            )}
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent-dim">
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-[#0a84ff]">
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
              </svg>
            </span>
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#0a84ff] transition-colors">証明書一覧</div>
          ...
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-success-dim">
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-[#30d158]">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              </svg>
            </span>
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#30d158] transition-colors">新規発行</div>
          ...
          >
            ...
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#0a84ff] transition-colors">顧客管理</div>
          ...
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-warning-dim">
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="text-[#ff9f0a]">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
            </span>
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#ff9f0a] transition-colors">請求書</div>
          ...
          >
            ...
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#ff9f0a] transition-colors">請求・プラン</div>
          ...
          >
            ...
            <div>
              <div className="text-sm font-semibold text-primary group-hover:text-[#0a84ff] transition-colors">テンプレート</div>
