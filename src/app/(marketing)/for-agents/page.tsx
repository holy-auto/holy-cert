    ...
    <>
      ...
      <Section bg="alt">
        ...
        <ScrollReveal variant="fade-up">
          <div className="mx-auto mt-10 max-w-2xl space-y-6">
            {[
              { step: "1", title: "パートナー申請", desc: "オンラインフォームから申請。審査完了後、専用ダッシュボードが利用可能に。" },
              { step: "2", title: "施工店を紹介", desc: "紹介リンクを発行し、施工店にLedraを案内。営業資料や研修コンテンツも提供。" },
              { step: "3", title: "契約成立", desc: "紹介先の施工店がLedraに登録・有料プランを契約するとコミッションが確定。" },
              { step: "4", title: "コミッション受取", desc: "Stripe Connect経由で毎月自動振込。ダッシュボードで実績をリアルタイムに確認。" },
            ].map((item) => (
      ...
      <Section bg="default">
        ...
        <FeatureGrid className="mt-10">
          <FeatureCard title="専用ダッシュボード" description="紹介数、成約率、コミッション実績をリアルタイムに把握。" />
          <FeatureCard title="紹介リンク管理" description="トラッキングURL を生成し、どの紹介がどの成約につながったかを可視化。" />
          <FeatureCard title="営業資料" description="提案書・パンフレット・動画などの営業素材をダウンロード可能。" />
          <FeatureCard title="ランキング" description="パートナー間の実績ランキングで切磋琢磨。上位パートナーには特別報酬も。" />
