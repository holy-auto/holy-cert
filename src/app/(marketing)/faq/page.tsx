      ...
      <Section>
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="はい、SSL暗号化通信、データの暗号化保存、定期的なバックアップなど、企業レベルのセキュリティ対策を実施しています。プロプランでは、アクセスログの詳細管理や監査ログ機能もご利用いただけます。"
          />
        </FAQList>
      </Section>
      ...
      <Section bg="alt">
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="はい、複数店舗でのご利用に対応しています。スタンダードプランでは最大2店舗、プロプランでは最大5店舗までご利用いただけます。追加店舗オプションもご用意しています。店舗ごとの発行管理も可能です。"
          />
          <FAQItem
      ...
      <Section>
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="プロプランでは、RESTful APIによる連携が可能です。証明書データの取得、検索、Webhook通知など、既存の社内システムとのシームレスな連携を実現します。"
          />
          <FAQItem
          ...
          <FAQItem
            ...
            answer="はい、CSV形式での一括エクスポートに対応しています。日付範囲や施工店での絞り込みも可能です。プロプランではAPI経由でのバッチ取得もご利用いただけます。"
          />
        </FAQList>
      </Section>
      ...
      <Section bg="alt">
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="はい、スタンダードプラン以上で請求書払い（月末締め・翌月末払い）に対応しています。月額・年額いずれのサブスクリプション料金も請求書でお支払いいただけます。フリー・スターターはクレジットカード決済のみとなります。"
          />
        </FAQList>
      </Section>
