  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 animate-pulse">
      ...
      <div className="space-y-2">
        ...
        <div className="h-4 w-64 rounded bg-border-subtle dark:bg-[rgba(255,255,255,0.06)]" />
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="glass-card p-5 space-y-2">
            ...
            <div className="h-3 w-12 rounded bg-border-subtle dark:bg-[rgba(255,255,255,0.06)]" />
          </div>
        ))}
      </div>
