  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold tracking-tight text-primary">よくある質問</h1>
        <p className="mt-1 text-sm text-muted">サービスや営業に関するよくある質問と回答</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {filtered.map((faq) => (
            <div key={faq.id} className="rounded-2xl border border-border-default bg-surface shadow-sm overflow-hidden">
              <button
