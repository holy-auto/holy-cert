...
| 段階 | 数 | 意味 |
|---|---|---|
| **Lighthouse** (本番接続・課金開始) | 1 社 | **損保ジャパン** (2026-05-13 経営が *標的* に決定。⚠️ 現時点で接点なし＝フェーズ0。接点獲得は PnP Japan Insurtech 応募 + 直接コールド。他 3 社は §3.2 のパイプライン枠へ) |
...
| 3 | ✅ Lighthouse 保険会社の **標的決定** → **損保ジャパン** (2026-05-13、経営判断のみ・接点未確立) | CEO | 決定済 |
...
| 9 | **接点獲得 (最優先・新規)**: Plug and Play Japan Insurtech 応募 (`docs/pnp-japan-insurtech-application.md`) + 損保ジャパン / パイプライン 3 社へ直接コールド並行 | CEO + BizDev | 即時着手 |
